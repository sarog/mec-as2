...
public class Update46to47 implements IUpdater {
    ...
    public void startUpdate(Connection connection) throws Exception {
        ...
        try {
            ...
            statement1.execute("CREATE TABLE serversettings(id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,vkey VARCHAR(256)NOT NULL,vvalue VARCHAR(256)NOT NULL);");
            statement2 = connection.createStatement();
            statement2.execute("CREATE INDEX idx_serversettings_vkey ON serversettings(vkey);");
