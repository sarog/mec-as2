//$Header: /as2/de/mendelson/util/clientserver/ResourceBundleGUIClient_it.java 4     4/04/25 9:43 Heller $
...
public class ResourceBundleGUIClient_it extends MecResourceBundle {
    ...
    private static final Object[][] CONTENTS = {
        {"error.client", "Si è verificato un problema nella connessione client-server tra questo client e il server: {0}"},
