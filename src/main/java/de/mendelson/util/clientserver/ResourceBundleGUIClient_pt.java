//$Header: /as2/de/mendelson/util/clientserver/ResourceBundleGUIClient_pt.java 3     4/04/25 9:43 Heller $
...
public class ResourceBundleGUIClient_pt extends MecResourceBundle {
    ...
    private static final Object[][] CONTENTS = {
        {"error.client", "Ocorreu um problema na ligação cliente-servidor deste cliente ao servidor: {0}"},
