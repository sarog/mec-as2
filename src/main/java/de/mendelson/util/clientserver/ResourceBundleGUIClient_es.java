//$Header: /as2/de/mendelson/util/clientserver/ResourceBundleGUIClient_es.java 3     4/04/25 9:43 Heller $
...
public class ResourceBundleGUIClient_es extends MecResourceBundle {
    ...
    private static final Object[][] CONTENTS = {
        {"error.client", "Se ha producido un problema en la conexión cliente-servidor entre este cliente y el servidor: {0}"},
