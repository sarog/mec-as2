//$Header: /as4/de/mendelson/util/clientserver/clients/preferences/ConfigurationChangedOnServer.java 6     11/06/25 13:16 Heller $
...
public class ConfigurationChangedOnServer extends ClientServerMessage implements Serializable{
    ...
    protected ConfigurationChangedOnServer() {
        super();
    }
