//$Header: /mec_as2/de/mendelson/util/systemevents/ResourceBundleSystemEventFilenames.java 34    15/04/26 12:44 Heller $
...
public class ResourceBundleSystemEventFilenames extends MecResourceBundle {
    ...
    private static final Object[][] CONTENTS = {
        ...
        {"type." + SystemEvent.Type.CERTIFICATE_MODIFY.toInt(), "Certificate (modify)"},
