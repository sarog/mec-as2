//$Header: /as4/de/mendelson/util/security/cert/gui/ResourceBundleCertificates_es.java 9     5/02/26 15:42 Heller $
...
public class ResourceBundleCertificates_es extends MecResourceBundle {
    ...
    private static final Object[][] CONTENTS = {
        ...
        {"label.key.invalid", "Esta clave no es válida {0}"},
        ...
        {"label.cert.invalid", "Este certificado no es válido {0}"},
        ...
        {"title.tls", "Claves y certificados (TLS)"},
        ...
        {"label.key.import.pem", "Importe su propia clave privada (PEM)" },  
        ...
        {"menu.tools.crmf", "Generación de solicitud CRMF (BDEW)"},
    };
}
