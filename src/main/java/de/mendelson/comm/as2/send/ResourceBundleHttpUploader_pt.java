//$Header: /as2/de/mendelson/comm/as2/send/ResourceBundleHttpUploader_pt.java 9     18/06/25 12:21 Heller $
...
public class ResourceBundleHttpUploader_pt extends MecResourceBundle {
	...
	private static final Object[][] CONTENTS = {
		...
		{"connected.to", "Ligado a {0}, espera por uma MDN e mantém a ligação aberta até {1}"},
		{"connection.shut.down", "A ligação de saída para {0} foi fechada, esteve aberta durante {1}s"},
		...
		{"httpheader.deleted", "O cabeçalho HTTP \"{0}\" foi eliminado devido às definições personalizadas do cabeçalho HTTP"},
		{"httpheader.replaced", "O valor do cabeçalho HTTP \"{0}\" foi substituído pelo valor definido pelo utilizador \"{1}\""},
		{"httpheader.set", "O cabeçalho HTTP \"{0}\" foi definido para o valor definido pelo utilizador \"{1}\""},
		{"returncode.accepted", "Mensagem enviada com êxito (HTTP {0}); {1} transmitida em {2} [{3}]."},
		{"returncode.ok", "Mensagem enviada com sucesso (HTTP {0}); {1} enviada em {2} [{3}]."},
		...
		{"using.proxy.auth", "Utilizar proxy {0}:{1} (autenticação como {2})."},
                {"httpheader.added.basicauth", "O cabeçalho HTTP para Autenticação Básica foi adicionado ao pedido de envio" },
	};
}
