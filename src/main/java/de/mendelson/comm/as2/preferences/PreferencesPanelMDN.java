//$Header: /as2/de/mendelson/comm/as2/preferences/PreferencesPanelMDN.java 32    17/03/26 9:24 Heller $
 ...
 * @version: $Revision: 32 $
 */
public final class PreferencesPanelMDN extends PreferencesPanel {
    ...
    protected static final MendelsonMultiResolutionImage IMAGE_PREFS
    ...
    public void loadPreferences() {
        this.jTextFieldAsyncMDNTimeout.setText(this.preferences.get(PreferencesAS2.MDN_WAIT_TIME));
    ...
    private String captureSettingsToStr() {
        ...
        builder.append(PreferencesAS2.MDN_WAIT_TIME).append("=")
    ...
    public void savePreferences() {
        try {
            ...
            if (value < 0) {
                value = Integer.parseInt(this.preferences.getDefaultValue(PreferencesAS2.MDN_WAIT_TIME));
            }
            try {
                this.preferences.putInt(PreferencesAS2.MDN_WAIT_TIME, value);
            } catch (Throwable e) {
    ...
    private void initComponents() {
        ...
        jTextFieldAsyncMDNTimeout.setMinimumSize(new java.awt.Dimension(50, 22));
        jTextFieldAsyncMDNTimeout.setPreferredSize(new java.awt.Dimension(50, 22));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        ...
        jPanelUIHelpLabelMDNTimeout.setToolTipText(this.rb.getResourceString( "label.mdn.timeout.help"));
        jPanelUIHelpLabelMDNTimeout.setText(this.rb.getResourceString( "label.mdn.timeout"));
        jPanelUIHelpLabelMDNTimeout.setTooltipWidth(400);
        gridBagConstraints = new java.awt.GridBagConstraints();
