//$Header: /mec_as2/de/mendelson/comm/as2/database/DBDriverManagerHSQL.java 39    15/04/26 12:42 Heller $
...
public class DBDriverManagerHSQL extends AbstractDBDriverManagerHSQL implements IDBDriverManager, ISQLQueryModifier {
    ...
    public static final String DB_PASSWORD = "as2dbadmin";
    ...
    public boolean createDatabase(final int DB_TYPE) throws Exception {
        try {
            ...
            try (Connection connection
                ...
                executor.create(connection, createResource, dbVersion, AS2ServerVersion.instance());
            } catch (Exception e) {
            ...
            SystemEvent event = new SystemEvent(
                    ...
                    SystemEvent.Type.DATABASE_CREATION);
